...
class block_mytermcourses extends block_base {
    ...
    public function get_content() {
        ...
        $this->content->text .= "<a href='$CFG->wwwroot/blocks/mytermcourses/oldcourses.php?year=$lastyear'><button id='oldcoursesbutton' class='btn btn-success' style='margin:5px'>"
